...
const AboutUs = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const subject = encodeURIComponent("Inquiry from PetBond User");
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <div data-aos="fade-right" className="space-y-6">
          <h2 className="text-2xl md:text-3xl font-black">More about us</h2>
        ...
        >
          <div className="relative z-10 space-y-8">
            ...
            <p className="text-white/90 text-2xs md:text-base max-w-sm">
              Have a question about your pet or our services? Reach out
              today—we’re here to help you and your furry friends!
            </p>
