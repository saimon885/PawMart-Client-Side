...
const AboutUs = () => {
  ...
  return (
    <div className="font-sans text-base-content selection:bg-primary/30 overflow-x-hidden">
      <title>PetBond - About Us</title>
      <div className="md:mt-5">
        <section
          data-aos="fade-right"
          className="bg-base-100 text-base-content py-10 md:py-28 px-6 relative overflow-hidden"
        >
            ...
            <div className="space-y-8 md:space-y-10">
              <div className="relative">
                ...
                <p className="text-base-content/70 text-lg md:text-xl leading-relaxed max-w-xl font-medium">
                  This is the most common type of veterinary practice, focusing
                  on the health and well-being of pets like dogs, cats, and
                  other small family members.
                </p>
              </div>
      ...
      <section className="py-24 md:py-32 relative overflow-hidden bg-base-200/30">
        ...
        <div data-aos="fade-up" className="text-center mb-16 px-6 relative z-2">
